...
public class Register implements Task {
    ...
    public static Register onthePage(String StrfirstName,
                                     String StrlastName,
                                     String Stremail,
                                     ...
                                     String Strzip,
                                     String StrcountryId,
                                     String StrosVersionId,
                                     String StrosLanguageId,
                                     String Strpassword,
                                     String StrconfirmPassword, String strconfirmPassword) {
        return Tasks.instrumented(Register.class, StrfirstName, StrlastName, Stremail, StrbirthMonth, StrbirthDay, StrbirthYear, Strcity, Strzip, StrcountryId,
                StrosVersionId, StrosLanguageId, Strpassword, StrconfirmPassword);
    }
